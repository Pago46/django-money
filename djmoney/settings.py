...
DECIMAL_PLACES_PER_CURRENCY = getattr(settings, 'DECIMAL_PLACES_PER_CURRENCY', None)
DISPLAY_DECIMAL_PLACES_PER_CURRENCY = getattr(settings, 'DISPLAY_DECIMAL_PLACES_PER_CURRENCY', None)
